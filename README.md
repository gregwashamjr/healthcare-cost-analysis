...
## 🚀 Executive Summary
This project analyzes hospital encounter data to evaluate how different payers cover the cost of care. The analysis focuses on identifying which encounter classes receive the highest and lowest levels of coverage, as well as comparing payer performance based on the percentage of costs they reimburse. By examining both encounter types and payer behavior, this project highlights patterns in healthcare spending and reveals where patients may experience greater financial burden.
...
- This hospital collects practically 0 payments from Humana, UnitedHealthcare, Aetna, Cigna and Anthem
- Medicare and Medicaid reimburse the highest and the most encounters
- Urgentcare encounters have the lowest reimbursement rate of all encounter types
